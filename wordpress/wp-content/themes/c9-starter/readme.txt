...
= 2.5.5 =
Updates to list item styling in defualt posts and pages.

= 2.5.4 =
Fixed default font size for list items bug.

= 2.5.3 =
Updates for WordPress 6.0 compatibility and better core button alignment/width support.

= 2.5.2 =
Updates to alignments for image floats and buttons to be more accurate in frontend and backend for animation accuracy. Updates for dev tools related to security and compatibility.

= 2.5.1 =
Better core social block icon support. Edits to classes for margin spacing.
...
= 2.4.8 =
Update to rounded image style, added screen reader text to social icons.
